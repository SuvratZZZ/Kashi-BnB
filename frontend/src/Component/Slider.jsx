...
const Slider = () => {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden">
            ...
            {/* Centered Text */}
            <div className="absolute top-1/2 left-1/2 bg-black/50 rounded-2xl transform -translate-x-1/2 -translate-y-1/2 text-center text-white p-6 w-11/12 md:w-2/3 lg:w-1/2">
                {/* Title */}
                <h1 className="text-4xl sm:text-4xl md:text-5xl font-bold drop-shadow-lg">Welcome to Kashi BnB</h1>
                <p className='text-lg sm:text-xl font-bold'>Explore Varanasi, The Oldest City</p>
                <p>where comfort meets trust in the heart of Varanasi! Enjoy hotel-like amenities, unbeatable value, and a homey vibe. Dive into the city’s spiritual charm while we ensure your stay is nothing short of perfect. Book now for an unforgettable experience!</p>
